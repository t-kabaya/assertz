...
test('must return String', async t => {
...
test('must create test FailureMessage when failureCount > 0', async t => {
  const input = { successCount: 1, failureCount: 9 }
...
test('must create test successMessage when failureCount = 0', async t => {
